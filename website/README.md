# neme.site - Personal Cloud Engineer Portfolio

Welcome to the source of [neme.site](https://neme.site), a cloud-native portfolio project, serving as both a live portfolio and a demonstration of modern DevOps, automation, and observability best practices.

---

## 📝 Overview

This project hosts a **static React portfolio** behind a secure NGINX proxy, deployed on an Oracle Cloud VM. It features fully automated HTTPS via Let's Encrypt (Certbot + Cloudflare DNS), infrastructure monitoring (Prometheus, Grafana), and modern CI/CD with GitLab. All infrastructure is managed with Docker Compose and ready for extension to Kubernetes.
...
Add to your `default.conf` under your HTTPS server block:
