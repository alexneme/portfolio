...
## Por que fazer o que todo mundo já fez?
Grande parte do conteúdo está em inglês. Pra mim é tranquilo, mas sei que pra muita gente é um baita bloqueio. Então a ideia é simples:  

Vou seguir o [roadmap oficial do 90DaysOfDevOps](https://github.com/MichaelCade/90DaysOfDevOps), mas vou contar aqui no meu jeito — misturando com a minha **experiência real**. E claro, vou  ~~tentar~~ trazer tudo em **português**, de forma mais próxima e prática.
...
- Git — perdeu o código que escreveu porque quis ¯\\\_(ツ)\_/¯  
- Containers & Kubernetes (a parte ~~tenebrosa~~ divertida).  
- Infra como código com Terraform.  
- Ansible pra gerência de configuração.  
- CI/CD pipelines de vários jeitos (sério, tem muitos jeitos).  
- Monitoramento, logs e dashboards bonitões.  
- Backup, recovery e como não deixar nada pegar fogo (e também como voltar tudo caso pegue).  
