...
## Why do what everyone else already did?  
Most of the content out there is in English. That’s fine for me, but I know for a lot of people it’s a big roadblock. So my idea is simple:  

I’ll follow the [official 90DaysOfDevOps roadmap](https://github.com/MichaelCade/90DaysOfDevOps), but I’ll share it my way — mixing in my **real-world experience**. And of course, I’ll ~~try to~~ bring it all in **Portuguese**, in a more practical and approachable way.  
...
- Git — lost your code because you didn’t commit? ¯\\\_(ツ)\_/¯  
- Containers & Kubernetes (the ~~scary~~ fun part).  
- Infrastructure as code with Terraform.  
- Ansible for configuration management.  
- CI/CD pipelines in different flavors (seriously, there are a lot).  
- Monitoring, logs, and fancy dashboards.  
- Backup, recovery, and how not to let things catch fire (and how to bring it all back if they do).  
