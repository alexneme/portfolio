...
import { FaDocker, FaLinux, FaPython, FaReact, FaNodeJs, FaGitAlt } from "react-icons/fa";
...
const techs = [
  ...
  { icon: FaPython, name: "Python", url: "https://python.org/", color: "text-yellow-400" },
    ...
    <div className="relative min-h-screen font-sans bg-gradient-to-br from-gray-50 via-neutral-100 to-slate-100 dark:from-gray-900 dark:via-gray-950 dark:to-slate-900 transition-all">
      ...
      <main className="relative z-10 flex flex-col items-center px-4 py-8">
        ...
        <div className="mt-10 w-full max-w-lg">
          <div className="rounded-lg text-center bg-white/80 dark:bg-gray-800/80 shadow p-4 text-slate-700 dark:text-slate-200">
            <a
              href="https://blog.neme.site"
              target="_blank"
              rel="noopener noreferrer"
              className="underline-offset-4 hover:no-underline focus:outline-none focus:ring"
            >
              {lang === "en"
              ? "Visit my blog!"
              : "Visite meu blog!"}
